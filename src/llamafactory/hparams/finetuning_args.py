...
class LoraArguments:
    ...
    density: Optional[float] = field(
        default=0.0,
        metadata={"help": "Density of the sparse adaptation matrix for Rosa fine-tuning."},
    )
    prune_ratio: Optional[float] = field(
        default=0.5,
        metadata={"help": "Prune ratio for  LoRAPrune fine-tuning."},
    )
    ...
    vera_dropout: Optional[float] = field(
        default=0.05,
        metadata={"help": "Drop possiblity in VeRA fine-tuning.. "}
    )
    doc_stride: Optional[int] = field(
        default=128,
        metadata={"help": "When splitting up a long document into chunks how much stride to take between chunks using in LoRAShear fine-tuning."}
    )

    group_sparsity: Optional[float] = field(
        default=0.1,
        metadata={"help": "Target group sparsity level in LoRAShear fine-tuning.. "}
    )
    lora_rank: int = field(
        default=8,
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    finetuning_type: Literal["lora", "adalora", "vera", "olora", "rosa", "loraprune", "lorashear", "freeze", "full"] = field(
        default="lora",
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "adalora", "vera" ,"olora", "rosa", "loraprune", "lorashear", "freeze", "full"], "Invalid fine-tuning method."
